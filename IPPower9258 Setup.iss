...
; Generated by Arie Blumenzweig on 3/6/2016 (UTC)
;
[Setup]
SetupLogging=yes
AppID={{ddf0432f-d04b-48c8-92b0-44de9fbf543a}
AppName=ASCOM IPPower9258 Switch Driver
AppVerName=ASCOM IPPower9258 Switch Driver 6.0
AppVersion=6.0
...
OutputDir="."
OutputBaseFilename="IPPower9258 Setup"
Compression=lzma
...
UninstallFilesDir="{cf}\ASCOM\Uninstall\Switch\IPPower9258"

[Languages]
Name: "english"; MessagesFile: "compiler:Default.isl"

[Dirs]
Name: "{cf}\ASCOM\Uninstall\Switch\IPPower9258"
; TODO: Add subfolders below {app} as needed (e.g. Name: "{app}\MyFolder")

[Files]  
Source: "C:\Users\Blumzi\Documents\Visual Studio 2015\Projects\PowerStrip\IP Power 9258\bin\Debug\ASCOM.IPPower9258.Switch.dll"; DestDir: "{app}"
...
Filename: "{dotnet4032}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.IPPower9258.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "/codebase ""{app}\ASCOM.IPPower9258.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
...
[UninstallRun]
; Only for .NET assembly/in-proc drivers
Filename: "{dotnet4032}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.IPPower9258.Switch.dll"""; Flags: runhidden 32bit
Filename: "{dotnet4064}\regasm.exe"; Parameters: "-u ""{app}\ASCOM.IPPower9258.Switch.dll"""; Flags: runhidden 64bit; Check: IsWin64
